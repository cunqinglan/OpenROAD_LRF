...
public:
  ...
  virtual bool searchThru(sta::Edge* edge, const sta::Mode* mode) const override;
  virtual bool searchFrom(const sta::Vertex* from_vertex, const sta::Mode* mode) const override;
  virtual bool searchTo(const sta::Vertex* to_vertex, const sta::Mode* mode) const override;
};
