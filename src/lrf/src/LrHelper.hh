...
typedef std::map<DcalcAPIndex, LMValue> DcalcAPToLMValueMap;
typedef std::map<DcalcAPIndex, LMValueSeq> DcalcAPToLMValueSeqMap;
...
protected:
  virtual void updateArcLms(Edge *edge, TimingArc *arc, Sta *sta, 
                    Scene *scene, const MinMax *min_max) override;
  virtual void updateEndPointArcLms(Edge *edge, TimingArc *arc, Sta *sta, 
                                    Scene *scene, const MinMax *min_max) override;
